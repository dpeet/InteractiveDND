...
from countdice2 import test_get_num_from_dice, get_num_from_dice
import json
...
################################# First page widgets! ##############################################################################
        ...
        def manualSelection(instance):
            if instance == clearButton:
                ...
                if (trackLabel.text == "..."):
                    trackLabel.text = instance.text
                else:
                    trackLabel.text = ("%s + %s" % (trackLabel.text, instance.text))
            ...
            if instance == initButton:
                ...
                if not selected1:
                    ...
                    if initFlag:
                        ...
                        selectedItem = list_adapter.selection[0].text
                        sLabel.color = (0,0,0,1)
##                        reslt = test_get_num_from_dice()
##                        print(totalManLabel.text.split(" "))
                        result = int(totalManLabel.text.split(" ")[4])
##                        print(reslt)
##                        print(sum(reslt))
                        totalManLabel.text = "The total value = 0"
                        trackLabel.text = "..."
                        sLabel.text = str(result+int(sLabel3.text))
                ...
                if not selected1:
                    ...
                    if initFlag:
                        ...
                        myList = txt.split("d")
                        myList2 = myList[1].split("+")
                        reslt = int(totalManLabel.text.split(" ")[4])
                        sLabel2.text = str(reslt+int(myList2[1]))
                        totalManLabel.text = "The total value = 0"
                        trackLabel.text = "..."
                ...
                if not selected1:
                    ...
                    if initFlag:
                        ...
                        sLabel.text = str(reslt+int(sLabel3.text))
...
################################# 0 page widgets! ########################################################################################
        ...
        spinner = Spinner(
                        ...
                        values=playerNames,
                        size_hint=(0.175*ratioD, 0.05),
                        pos_hint={'center_x': .9*ratioD, 'center_y': .95})
...
################################# First page widgets! ####################################################################################
        exitButton = Button(
            text = 'Exit',
            size_hint=(0.175*ratioD, 0.05),
            pos_hint={'center_x': .5*ratioD, 'center_y': .95})
        ...
        dImg1 = Image(source='./images/box.png',
                        pos_hint = {'center_x': .5*ratioD, 'center_y': .35},
                        size_hint = (.9*ratioD,.7))

        initButton = Button(
            size_hint=(get_scalex_and_y(125,125,125)[0]*ratioD, get_scalex_and_y(125,125,125)[1]),
            background_normal="./images/button_init.png",
            pos_hint={'center_x': .20*ratioD, 'center_y': .4})
        ...
        stButton = Button(
            ...
            pos_hint={'center_x': .5*ratioD, 'center_y': .4})
        ...
        wpButton = Button(
            ...
            pos_hint={'center_x': .8*ratioD, 'center_y': .4})
        ...
        skButton = Button(
            ...
            pos_hint={'center_x': .2*ratioD, 'center_y': .2})
        ...
        spButton = Button(
            ...
            pos_hint={'center_x': .5*ratioD, 'center_y': .2})
        ...
        saButton = Button(
            ...
            pos_hint={'center_x': .8*ratioD, 'center_y': .20})
        ...
        tLabel = Label(
            ...
            pos_hint={'center_x': .5*ratioD, 'center_y': .765}
        )
        self.add_widget(tLabel)

        dragon = Image(
            source="./images/Dragon_Title.png",
            size_hint=(ratioD, ratioD),
            pos_hint = {'center_x': .5*ratioD, 'center_y': .78}
        )
        ...
        dLabel = Label(
            ...
            font_size='45sp',
            font_name='./images/Captain_Redemption.ttf',
            pos_hint={'center_x': .5*ratioD, 'center_y': .6})
...
################################# Second page widgets! ##############################################################################
        ...
        dImg2 = Image(source='./images/box2.png',
                        pos_hint = {'center_x': .48*ratioD, 'center_y': .45},
                        size_hint = (.16*ratioD,.16*ratioD))

        dImg3 = Image(source='./images/box2.png',
                        pos_hint = {'center_x': .48*ratioD, 'center_y': .25},
                        size_hint = (.16*ratioD,.16*ratioD))
        ...
        backButton = Button(
            ...
            color=(1, 1, 1, 1),
            size_hint=(0.175*ratioD, 0.05),
            pos_hint={'center_x': .1*ratioD, 'center_y': .95})
        ...
        manualButton = Button(
            ...
            color=(255, 255, 255, 1),
            size_hint=(0.175*ratioD, 0.05),
            pos_hint={'center_x': .25*ratioD, 'center_y': .1})
        ...
        autoButton = Button(
            ...
            color=(255, 255, 255, 1),
            size_hint=(0.175*ratioD, 0.05),
            pos_hint={'center_x': .5*ratioD, 'center_y': .1})
        ...
        autoButton2 = Button(
            ...
            color=(255, 255, 255, 1),
            size_hint=(0.175*ratioD, 0.05),
            pos_hint={'center_x': .75*ratioD, 'center_y': .1})
        autoButton2.bind(on_press=dieSelect)

        attack = Image(
            source="./images/Field_Attack.png",
            pos_hint={'center_x': .25*ratioD, 'center_y': .43}
        )

        Damage = Image(
            source="./images/Field_Damage.png",
            pos_hint={'center_x': .25*ratioD, 'center_y': .23}
        )
        ...
        sLabel = Label(
                ...
                font_size='40sp',
                font_name= './images/Captain_Redemption.ttf',
                pos_hint = {'center_x': .25*ratioD, 'center_y': .45})
        ...
        sLabel2 = Label(
                ...
                font_size='40sp',
                font_name= './images/Captain_Redemption.ttf',
                pos_hint = {'center_x': .25*ratioD, 'center_y': .25})
        ...
        sLabel5 = Label(
                ...
                font_size='25sp',
                font_name= './images/Captain_Redemption.ttf',
                pos_hint = {'center_x': .2*ratioD, 'center_y': .6})
        ...
        list_view = ListView(adapter = list_adapter,
                             pos_hint = {'center_x': .75*ratioD, 'center_y': .37},
                             size_hint = (0.25*ratioD, 0.35))
...
################################# Init page widgets! ####################################################################################
        ...
        list_view2 = ListView(adapter = list_adapter2,
                             pos_hint = {'center_x': .25*ratioD, 'center_y': .28},
                             size_hint = (0.25*ratioD, 0.5))
        ...
        list_view3 = ListView(adapter = list_adapter3,
                             pos_hint = {'center_x': .75*ratioD, 'center_y': .28},
                             size_hint = (0.25*ratioD, 0.5))
        ...
        totalValLabel = Label(
                ...
                font_size='80sp',
                font_name= './images/Captain_Redemption.ttf',
                pos_hint = {'center_x': .5*ratioD, 'center_y': .5})
        ...
        skStatLabel = Label(
                ...
                font_size='33sp',
                font_name= './images/Captain_Redemption.ttf',
                pos_hint = {'center_x': .48*ratioD, 'center_y': .37})
...
#################################################################################################################################
        ...
        num1Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .16*ratioD+.5, 'center_y': yValf})
        ...
        num2Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .32*ratioD+.5, 'center_y': yValf})
        ...
        num3Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .48*ratioD+.5, 'center_y': yValf})
        ...
        num4Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .64*ratioD+.5, 'center_y': yValf})
        ...
        num5Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .8*ratioD+.5, 'center_y': yValf})
...
#################################################################################################################################
        ...
        num6Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .16*ratioD+.5, 'center_y': yVals})
        ...
        num7Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .32*ratioD+.5, 'center_y': yVals})
        ...
        num8Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .48*ratioD+.5, 'center_y': yVals})
        ...
        num9Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .64*ratioD+.5, 'center_y': yVals})
        ...
        num10Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .8*ratioD+.5, 'center_y': yVals})
...
#################################################################################################################################
        ...
        num11Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .16*ratioD+.5, 'center_y': yValt})
        ...
        num12Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .32*ratioD+.5, 'center_y': yValt})
        ...
        num13Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .48*ratioD+.5, 'center_y': yValt})
        ...
        num14Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .64*ratioD+.5, 'center_y': yValt})
        ...
        num15Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .8*ratioD+.5, 'center_y': yValt})
...
#################################################################################################################################
        ...
        num16Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .16*ratioD+.5, 'center_y': yValfr})
        ...
        num17Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .32*ratioD+.5, 'center_y': yValfr})
        ...
        num18Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .48*ratioD+.5, 'center_y': yValfr})
        ...
        num19Button = Button(
                        ...
                        font_size='40sp',
                        size_hint = (.08,.08),
                        pos_hint = {'center_x': .64*ratioD+.5, 'center_y': yValfr})
        ...
        num20Button = Button(
                        ...
                        size_hint = (.08,.08),
                        font_size='40sp',
                        pos_hint = {'center_x': .8*ratioD+.5, 'center_y': yValfr})
        ...
        self.add_widget(num1Button)
        self.add_widget(num2Button)
        self.add_widget(num3Button)
        self.add_widget(num4Button)
        self.add_widget(num5Button)
        self.add_widget(num6Button)
        self.add_widget(num7Button)
        self.add_widget(num8Button)
        self.add_widget(num9Button)
        self.add_widget(num10Button)
        self.add_widget(num11Button)
        self.add_widget(num12Button)
        self.add_widget(num13Button)
        self.add_widget(num14Button)
        self.add_widget(num15Button)
        self.add_widget(num16Button)
        self.add_widget(num17Button)
        self.add_widget(num18Button)
        self.add_widget(num19Button)
        self.add_widget(num20Button)        
